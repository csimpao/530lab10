...
function App() {
  return (
    <div className="App">
      ...
      <p>Since I have a Mac, React is already installed into the system</p> 
      ...
      <p>Once I finished my changes, I committed and pushed my changes onto the GitHub repository using git, and it takes a bit for the page to update</p>

      <h2>3. Difficulties</h2>
      <p>Apparently I had to make a copy of my GitHub repository in Vercel using a new name, which it made harder for git to push and commit the changes to the correct folder</p>
      <p>So, I had to manually go to the repository clone and manually change the code, but it will still display the updated webpage as soon as I commit those changes</p>
    </div>
  );
}
